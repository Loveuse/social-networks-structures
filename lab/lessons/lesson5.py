...
from pageRankCentrality import pageRankCentrality
...
def top(graph,k,centrality, confidence=None):
  
  if centrality == 'b':
    b = betweenness(graph)
  elif centrality == 'e':
    b = eigenvector(graph, confidence)
  elif centrality == 'p':
    b = pageRankCentrality(graph, confidence)
